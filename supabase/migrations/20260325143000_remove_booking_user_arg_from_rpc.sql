...
drop function if exists public.book_parking_spot(uuid, uuid, timestamptz, timestamptz, numeric);
...
grant execute on function public.book_parking_spot(uuid, timestamptz, timestamptz, numeric) to authenticated;
